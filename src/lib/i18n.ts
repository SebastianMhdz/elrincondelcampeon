...
export const translations: Record<Locale, Translation> = {
  es: {
    ...
    welcomeTo: "Bienvenido a", fastestWayToPlay: "La forma más rápida de jugar", yourNextMatch: "tu próximo partido",
    viewCourts: "Ver canchas", statCourts: "Canchas", statUpcomingTournaments: "Torneos próximos", statNextPlay: "Tu próxima jugada",
    upcomingTournaments: "Próximos torneos", viewAll: "Ver todos →", loadingShort: "Cargando…",
    noTournamentsScheduled: "Todavía no hay torneos programados", newEventsSoon: "Pronto se publicarán nuevos eventos. ¡No te los pierdas!",
    signupsOpenBadge: "Inscripciones abiertas", comingSoonBadge: "Próximamente", capacityTeams: "Cupo {n} equipos",
    topRated: "Mejor valoradas", bestPrices: "Mejores precios", fromLabel: "desde",
    tournamentsTitle: "Torneos", tournamentsHint: "Eventos programados en las canchas. Inscríbete o crea tu propio torneo.",
    createTournament: "Crear torneo", signInToCreate: "Inicia sesión para crear",
    filterAll: "Todos", filterOpen: "Inscripciones abiertas", filterMine: "Mis torneos",
    noTournamentsToShow: "No hay torneos para mostrar", createFirstOne: "¡Crea el primero!", signInToCreateOne: "Inicia sesión para crear uno.",
    inProgress: "En curso", openShort: "Abierto", finished: "Finalizado", upcoming: "Próximo", freeSlots: "{n} cupos libres →",
    backToTournaments: "Volver a torneos", scheduled: "Programado", signupsOpenLong: "Inscripciones abiertas",
    datesLabel: "Fechas", slotsLabel: "Cupos", slotsFree: "{n} libres", slotsFull: "Completo",
    formatLabel: "Modalidad", prizeLabel: "Premio",
    signupsTitle: "Inscripciones", signupsClosed: "Inscripciones cerradas", signupsClosedDesc: "Solo se anuncia el torneo. Atento a los anuncios del organizador.",
    signInToRegister: "Inicia sesión para inscribir tu equipo", registeredAs: "Inscrito como",
    willNotifyAnnouncements: "Te avisaremos por anuncios.", cancelSignup: "Cancelar", slotsExhausted: "Cupos agotados",
    teamNameLabel: "Nombre del equipo", teamNamePlaceholder: "Los Cracks FC", phoneShort: "Teléfono", phonePlaceholder57: "+57 300...", registerTeam: "Inscribir equipo",
    tournamentAnnouncements: "Anuncios del torneo", announcementTitle: "Título del anuncio", announcementBody: "Detalles, horarios, partidos...",
    ...
    pastDateError: "No puedes reservar en fechas pasadas.",
    paymentSummary: "Resumen de pago",
    variesByHour: "⚡ La tarifa varía por franja horaria.",
    totalLabel: "Total",
    partialPaymentRequired: "Pago parcial requerido (30%)",
    remainingAtSite: "Saldo restante en sitio",
    paymentMethods: "Métodos de pago",
    choosePayment: "Elige cómo deseas pagar para confirmar tu reserva.",
    partialPayment: "Pago parcial (30%)",
    partialPaymentDesc: "Confirma con el depósito y paga el resto en sitio.",
    fullPayment: "Pago completo (100%)",
    fullPaymentDesc: "Cancela todo ahora, sin saldo pendiente.",
    totalReservation: "Total reserva",
    payNow: "A pagar ahora",
    balanceAtSite: "Saldo en sitio",
    amountLabel: "Monto",
    copy: "Copiar",
    copied: "Copiado",
    payOnlineLink: "Pagar en línea",
    paymentInstructions: "Una vez realices el pago, envía el comprobante por WhatsApp o al correo de contacto. Tu reserva quedará confirmada al validarlo.",
    availabilityCalendar: "Disponibilidad del calendario",
    pickDateToSeeHours: "Selecciona un día para ver las horas disponibles.",
    available: "Disponible",
    occupied: "Ocupada",
    legendAvailable: "Verde: día con todas las horas libres",
    legendSomeBusy: "Naranja: día con algunas horas ocupadas",
  ...
  en: {
    ...
    welcomeTo: "Welcome to", fastestWayToPlay: "The fastest way to play", yourNextMatch: "your next match",
    viewCourts: "View courts", statCourts: "Courts", statUpcomingTournaments: "Upcoming tournaments", statNextPlay: "Your next play",
    upcomingTournaments: "Upcoming tournaments", viewAll: "View all →", loadingShort: "Loading…",
    noTournamentsScheduled: "No tournaments scheduled yet", newEventsSoon: "New events will be published soon. Don't miss them!",
    signupsOpenBadge: "Sign-ups open", comingSoonBadge: "Coming soon", capacityTeams: "{n} teams capacity",
    topRated: "Top rated", bestPrices: "Best prices", fromLabel: "from",
    tournamentsTitle: "Tournaments", tournamentsHint: "Scheduled events at the courts. Sign up or create your own.",
    createTournament: "Create tournament", signInToCreate: "Sign in to create",
    filterAll: "All", filterOpen: "Sign-ups open", filterMine: "My tournaments",
    noTournamentsToShow: "No tournaments to show", createFirstOne: "Create the first one!", signInToCreateOne: "Sign in to create one.",
    inProgress: "In progress", openShort: "Open", finished: "Finished", upcoming: "Upcoming", freeSlots: "{n} free slots →",
    backToTournaments: "Back to tournaments", scheduled: "Scheduled", signupsOpenLong: "Sign-ups open",
    datesLabel: "Dates", slotsLabel: "Slots", slotsFree: "{n} free", slotsFull: "Full",
    formatLabel: "Format", prizeLabel: "Prize",
    signupsTitle: "Sign-ups", signupsClosed: "Sign-ups closed", signupsClosedDesc: "The tournament is only being announced. Watch organizer announcements.",
    signInToRegister: "Sign in to register your team", registeredAs: "Registered as",
    willNotifyAnnouncements: "We'll notify you via announcements.", cancelSignup: "Cancel", slotsExhausted: "No slots left",
    teamNameLabel: "Team name", teamNamePlaceholder: "The Stars FC", phoneShort: "Phone", phonePlaceholder57: "+57 300...", registerTeam: "Register team",
    tournamentAnnouncements: "Tournament announcements", announcementTitle: "Announcement title", announcementBody: "Details, schedule, matches...",
    ...
    signupCancelled: "Sign-up cancelled", missingData: "Missing data", announcementPosted: "Announcement posted",
    sessionClosed: "Signed out", byeShort: "See you 👋",
    pastDateError: "You cannot book past dates.",
    paymentSummary: "Payment summary",
    variesByHour: "⚡ Rate varies by time slot.",
    totalLabel: "Total",
    partialPaymentRequired: "Partial payment required (30%)",
    remainingAtSite: "Remaining at site",
    paymentMethods: "Payment methods",
    choosePayment: "Choose how you want to pay to confirm your booking.",
    partialPayment: "Partial payment (30%)",
    partialPaymentDesc: "Confirm with the deposit and pay the rest on site.",
    fullPayment: "Full payment (100%)",
    fullPaymentDesc: "Pay everything now, no balance left.",
    totalReservation: "Booking total",
    payNow: "To pay now",
    balanceAtSite: "Balance on site",
    amountLabel: "Amount",
    copy: "Copy",
    copied: "Copied",
    payOnlineLink: "Pay online",
    paymentInstructions: "Once you pay, send the receipt by WhatsApp or email. Your booking will be confirmed upon validation.",
    availabilityCalendar: "Availability calendar",
    pickDateToSeeHours: "Pick a day to see available hours.",
    available: "Available",
    occupied: "Booked",
    legendAvailable: "Green: day fully available",
    legendSomeBusy: "Orange: day with some hours booked",
  ...
  pt: {
    ...
    welcomeTo: "Bem-vindo ao", fastestWayToPlay: "A forma mais rápida de jogar", yourNextMatch: "sua próxima partida",
    viewCourts: "Ver campos", statCourts: "Campos", statUpcomingTournaments: "Torneios próximos", statNextPlay: "Sua próxima jogada",
    upcomingTournaments: "Próximos torneios", viewAll: "Ver todos →", loadingShort: "Carregando…",
    noTournamentsScheduled: "Ainda não há torneios programados", newEventsSoon: "Em breve novos eventos. Não perca!",
    signupsOpenBadge: "Inscrições abertas", comingSoonBadge: "Em breve", capacityTeams: "Capacidade {n} times",
    topRated: "Melhor avaliados", bestPrices: "Melhores preços", fromLabel: "a partir de",
    tournamentsTitle: "Torneios", tournamentsHint: "Eventos programados nos campos. Inscreva-se ou crie o seu.",
    createTournament: "Criar torneio", signInToCreate: "Entre para criar",
    filterAll: "Todos", filterOpen: "Inscrições abertas", filterMine: "Meus torneios",
    noTournamentsToShow: "Sem torneios para mostrar", createFirstOne: "Crie o primeiro!", signInToCreateOne: "Entre para criar um.",
    inProgress: "Em andamento", openShort: "Aberto", finished: "Finalizado", upcoming: "Próximo", freeSlots: "{n} vagas livres →",
    backToTournaments: "Voltar a torneios", scheduled: "Programado", signupsOpenLong: "Inscrições abertas",
    datesLabel: "Datas", slotsLabel: "Vagas", slotsFree: "{n} livres", slotsFull: "Completo",
    formatLabel: "Modalidade", prizeLabel: "Prêmio",
    signupsTitle: "Inscrições", signupsClosed: "Inscrições fechadas", signupsClosedDesc: "O torneio só está sendo anunciado. Acompanhe os avisos do organizador.",
    signInToRegister: "Entre para inscrever seu time", registeredAs: "Inscrito como",
    willNotifyAnnouncements: "Avisaremos por anúncios.", cancelSignup: "Cancelar", slotsExhausted: "Sem vagas",
    teamNameLabel: "Nome do time", teamNamePlaceholder: "Os Cracks FC", phoneShort: "Telefone", phonePlaceholder57: "+57 300...", registerTeam: "Inscrever time",
    tournamentAnnouncements: "Anúncios do torneio", announcementTitle: "Título do anúncio", announcementBody: "Detalhes, horários, partidas...",
    ...
    signupCancelled: "Inscrição cancelada", missingData: "Faltam dados", announcementPosted: "Anúncio publicado",
    sessionClosed: "Sessão encerrada", byeShort: "Até logo 👋",
    pastDateError: "Você não pode reservar em datas passadas.",
    paymentSummary: "Resumo do pagamento",
    variesByHour: "⚡ A tarifa varia por faixa horária.",
    totalLabel: "Total",
    partialPaymentRequired: "Pagamento parcial obrigatório (30%)",
    remainingAtSite: "Saldo no local",
    paymentMethods: "Métodos de pagamento",
    choosePayment: "Escolha como deseja pagar para confirmar sua reserva.",
    partialPayment: "Pagamento parcial (30%)",
    partialPaymentDesc: "Confirme com o depósito e pague o restante no local.",
    fullPayment: "Pagamento completo (100%)",
    fullPaymentDesc: "Pague tudo agora, sem saldo pendente.",
    totalReservation: "Total da reserva",
    payNow: "A pagar agora",
    balanceAtSite: "Saldo no local",
    amountLabel: "Valor",
    copy: "Copiar",
    copied: "Copiado",
    payOnlineLink: "Pagar online",
    paymentInstructions: "Após pagar, envie o comprovante por WhatsApp ou email. Sua reserva será confirmada após validação.",
    availabilityCalendar: "Calendário de disponibilidade",
    pickDateToSeeHours: "Escolha um dia para ver os horários disponíveis.",
    available: "Disponível",
    occupied: "Ocupado",
    legendAvailable: "Verde: dia totalmente livre",
    legendSomeBusy: "Laranja: dia com algumas horas ocupadas",
  ...
  de: {
    ...
    welcomeTo: "Willkommen bei", fastestWayToPlay: "Der schnellste Weg zu spielen", yourNextMatch: "dein nächstes Spiel",
    viewCourts: "Plätze ansehen", statCourts: "Plätze", statUpcomingTournaments: "Kommende Turniere", statNextPlay: "Dein nächster Spielzug",
    upcomingTournaments: "Kommende Turniere", viewAll: "Alle ansehen →", loadingShort: "Lädt…",
    noTournamentsScheduled: "Noch keine Turniere geplant", newEventsSoon: "Bald neue Events. Nicht verpassen!",
    signupsOpenBadge: "Anmeldungen offen", comingSoonBadge: "Demnächst", capacityTeams: "{n} Teams Kapazität",
    topRated: "Top bewertet", bestPrices: "Beste Preise", fromLabel: "ab",
    tournamentsTitle: "Turniere", tournamentsHint: "Geplante Events. Melde dich an oder erstelle dein eigenes.",
    createTournament: "Turnier erstellen", signInToCreate: "Anmelden zum Erstellen",
    filterAll: "Alle", filterOpen: "Anmeldungen offen", filterMine: "Meine Turniere",
    noTournamentsToShow: "Keine Turniere", createFirstOne: "Erstelle das erste!", signInToCreateOne: "Anmelden zum Erstellen.",
    inProgress: "Läuft", openShort: "Offen", finished: "Beendet", upcoming: "Demnächst", freeSlots: "{n} freie Plätze →",
    backToTournaments: "Zurück zu Turnieren", scheduled: "Geplant", signupsOpenLong: "Anmeldungen offen",
    datesLabel: "Daten", slotsLabel: "Plätze", slotsFree: "{n} frei", slotsFull: "Voll",
    formatLabel: "Format", prizeLabel: "Preis",
    signupsTitle: "Anmeldungen", signupsClosed: "Anmeldungen geschlossen", signupsClosedDesc: "Das Turnier wird nur angekündigt. Achte auf Mitteilungen des Organisators.",
    signInToRegister: "Melde dich an, um dein Team einzutragen", registeredAs: "Angemeldet als",
    willNotifyAnnouncements: "Wir informieren dich per Mitteilung.", cancelSignup: "Abbrechen", slotsExhausted: "Keine Plätze",
    teamNameLabel: "Teamname", teamNamePlaceholder: "Die Stars FC", phoneShort: "Telefon", phonePlaceholder57: "+57 300...", registerTeam: "Team anmelden",
    tournamentAnnouncements: "Turnier-Mitteilungen", announcementTitle: "Titel der Mitteilung", announcementBody: "Details, Zeitplan, Spiele...",
    ...
    signupCancelled: "Anmeldung storniert", missingData: "Daten fehlen", announcementPosted: "Mitteilung veröffentlicht",
    sessionClosed: "Abgemeldet", byeShort: "Bis bald 👋",
    pastDateError: "Du kannst keine vergangenen Tage buchen.",
    paymentSummary: "Zahlungsübersicht",
    variesByHour: "⚡ Tarif variiert je nach Zeitfenster.",
    totalLabel: "Gesamt",
    partialPaymentRequired: "Teilzahlung erforderlich (30%)",
    remainingAtSite: "Restbetrag vor Ort",
    paymentMethods: "Zahlungsmethoden",
    choosePayment: "Wähle, wie du zahlen möchtest, um die Buchung zu bestätigen.",
    partialPayment: "Teilzahlung (30%)",
    partialPaymentDesc: "Mit Anzahlung bestätigen, Rest vor Ort.",
    fullPayment: "Vollzahlung (100%)",
    fullPaymentDesc: "Alles jetzt zahlen, kein Restbetrag.",
    totalReservation: "Buchungssumme",
    payNow: "Jetzt zu zahlen",
    balanceAtSite: "Restbetrag vor Ort",
    amountLabel: "Betrag",
    copy: "Kopieren",
    copied: "Kopiert",
    payOnlineLink: "Online bezahlen",
    paymentInstructions: "Nach der Zahlung sende den Beleg per WhatsApp oder E-Mail. Die Buchung wird nach Prüfung bestätigt.",
    availabilityCalendar: "Verfügbarkeitskalender",
    pickDateToSeeHours: "Wähle einen Tag, um die verfügbaren Zeiten zu sehen.",
    available: "Verfügbar",
    occupied: "Belegt",
    legendAvailable: "Grün: Tag komplett frei",
    legendSomeBusy: "Orange: Tag mit einigen belegten Stunden",
